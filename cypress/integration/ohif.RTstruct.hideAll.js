...
describe('should QC functionality display eye-icon filter option for the first ten RTstruct filter options', () => {
    ...
    it('should select Body outline (EXTERNAL) filter option to be hidden', () => {

        cy.get(':nth-child(1) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('bodyOutline')
        cy.get('@bodyOutline').click()
        cy.get('@bodyOutline').should('have.class', 'eye-icon false')

    });


    it('should select Cord (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(2) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('Cord')
        cy.get('@Cord').click({ force: true })
        cy.get('@Cord').should('have.class', 'eye-icon false')

    });

    it('should select CouchSurface (SUPPORT) filter option to be hidden', () => {
    ...
    it('should select CouchInterior (SUPPORT) filter option to be hidden', () => {
        ...
        cy.get('@CouchInterior').should('have.class', 'eye-icon false')

    });

    it('should select CouchRailLeft (SUPPORT) filter option to be hidden', () => {
        ...
        cy.get('@CouchRailLeft').should('have.class', 'eye-icon false')

    });

    it('should select CouchRailRight (SUPPORT) filter option to be hidden', () => {
        ...
        cy.get('@CouchRailRight').should('have.class', 'eye-icon false')

    });

    it('should select Rparotid (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(7) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('Rparotid')
        cy.get('@Rparotid').click({ force: true })
        cy.get('@Rparotid').should('have.class', 'eye-icon false')
        cy.get(':nth-child(7) > .tableListItem > .itemContent').click()

    });

    it('should select Lparotid (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(8) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('Lparotid')
        cy.get('@Lparotid').click({ force: true })
        cy.get('@Lparotid').should('have.class', 'eye-icon false')


    });

    it('should select OPTIC NERVE R (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@OpticNerveR').should('have.class', 'eye-icon false')


    });

    it('should select OPTIC NERVE L (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@OpticNerveL').should('have.class', 'eye-icon false')
...
describe('should QC functionality display eye-icon filter option for the next ten RTstruct filter options', () => {
    ...
    it('should select COCHLEA R (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@CochleaR').should('have.class', 'eye-icon false')
        cy.get(':nth-child(11) > .tableListItem > .itemContent').click()

    });

    it('should select COCHLEA L (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@CochleaL').should('have.class', 'eye-icon false')

    });

    it('should select Mandible (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@Mandible').should('have.class', 'eye-icon false')

    });

    it('should select Brainstem (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@Brainstem').should('have.class', 'eye-icon false')

    });

    it('should select Optic Chiasm (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@OpticChiasm').should('have.class', 'eye-icon false')

    });

    it('should select Unknown filter option to be hidden', () => {

        cy.get(':nth-child(16) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('Unknown')
        cy.get('@Unknown').click({ force: true })
        cy.get('@Unknown').should('have.class', 'eye-icon false')

    });

    it('should select GTV 70 (GTV) filter option to be hidden', () => {

        cy.get(':nth-child(17) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('GTV70')
        cy.get('@GTV70').click({ force: true })
        cy.get('@GTV70').should('have.class', 'eye-icon false')

    });

    it('should select GTV NODE 70 (GTV) filter option to be hidden', () => {
        ...
        cy.get('@GTVNODE70').should('have.class', 'eye-icon false')

    });

    it('should select GTV 70 COMBINED (GTV) filter option to be hidden', () => {
        ...
        cy.get('@GTV70COMBINED').should('have.class', 'eye-icon false')

    });

    it('should select CTV 70 (CTV) filter option to be hidden', () => {

        cy.get(':nth-child(20) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('CTV70')
        cy.get('@CTV70').click({ force: true })
        cy.get('@CTV70').should('have.class', 'eye-icon false')
...
describe('should QC functionality display eye-icon filter option for the next ten RTstruct filter options', () => {
    ...
    it('should select CTV 60 NODES (CTV) filter option to be hidden', () => {
        ...
        cy.get('@CTV60NODES').should('have.class', 'eye-icon false')

    });

    it('should select PTV60NODES (PTV) filter option to be hidden', () => {
        ...
        cy.get('@PTV60NODES').should('have.class', 'eye-icon false')

    });

    it('should select CTV 54 (CTV) filter option to be hidden', () => {

        cy.get(':nth-child(25) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('CTV54')
        cy.get('@CTV54').click({ force: true })
        cy.get('@CTV54').should('have.class', 'eye-icon false')

    });

    it('should select PTV 54 (PTV) filter option to be hidden', () => {

        cy.get(':nth-child(26) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('PTV54')
        cy.get('@PTV54').click({ force: true })
        cy.get('@PTV54').should('have.class', 'eye-icon false')

    });

    it('should select Cord+3 (PTV) filter option to be hidden', () => {

        cy.get(':nth-child(27) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('Cord+3')
        cy.get('@Cord+3').click({ force: true })
        cy.get('@Cord+3').should('have.class', 'eye-icon false')

    });

    it('should select Partoid L-PTV60 (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@PartoidL-PTV60+3').should('have.class', 'eye-icon false')

    });

    it('should select Partoid R-PTV54 (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@PartoidL-PTV64').should('have.class', 'eye-icon false')

    });

    it('should select PTV60+NODES 60 (PTV) filter option to be hidden', () => {
        ...
        cy.get('@PTV60+NODES60').should('have.class', 'eye-icon false')
...
describe('should QC functionality display eye-icon filter option for the next ten RTstruct filter options', () => {
    ...
    it('should select 5400control filter option to be hidden', () => {
        ...
        cy.get('@5400control').should('have.class', 'eye-icon false')

    });

    it('should select CTV IRO (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(32) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('CTVIRO')
        cy.get('@CTVIRO').click({ force: true })
        cy.get('@CTVIRO').should('have.class', 'eye-icon false')

    });

    it('should select CTV LRO (ORGAN) filter option to be hidden', () => {
    ...
    it('should select b (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(34) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('b')
        cy.get('@b').click({ force: true })
        cy.get('@b').should('have.class', 'eye-icon false')

    });

    it('should select b0 (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(35) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('b0')
        cy.get('@b0').click({ force: true })
        cy.get('@b0').should('have.class', 'eye-icon false')

    });

    it('should select sc0 (ORGAN) filter option to be hidden', () => {

        cy.get(':nth-child(36) > .tableListItem > .itemContent > :nth-child(1) > .item-label > .eye-icon').as('sc0')
        cy.get('@sc0').click({ force: true })
        cy.get('@sc0').should('have.class', 'eye-icon false')

    })

    it('should select Partoid R0 (ORGAN) filter option to be hidden', () => {
        ...
        cy.get('@PartoidR0').should('have.class', 'eye-icon false')
