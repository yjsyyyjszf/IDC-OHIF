...
describe('should QC functionality display eye-icon filter option for the first ten ANON filter options', () => {

    it('should hide all filter options', () => {

        cy.get('[style="margin-bottom: 0px; height: 100%;"] > .header > .icons > .eye-icon').click({ force: true })
